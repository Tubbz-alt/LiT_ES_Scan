...
PARAM.INIT.SIGZ0 = 6.60E-3; % RMS bunch length (m)
PARAM.INIT.SIGD0 = 8.11E-4; % RMS energy spread
...
PARAM.NRTL.AMPL  = 0.04040; % RTL compressor ampl (MV)
...
PARAM.LONE.DECK  = -21.93;  % Staggered chirp
...
PARAM.LI20.R56   = 0.0070;  % Sector 20 chicane R56 (m)
PARAM.LI20.T566  = 0.190;   % Sector 20 chicane T566 (m) % = 100 mm for R56 = 5mm from YS
